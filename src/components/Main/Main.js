...
const Main = () => {
  ...
  pokemons[0]?.name && console.log(pokemons);
        ...
        pokemons
          ...
          .map((poke, index) => {
            return (
              <div
                key={index}
                className="flex flex-col items-center border-1 mx-1 my-3 rounded-2xl bg-[#f2f2f2] shadow-md hover:bg-gray-200 hover:cursor-pointer hover:shadow-2xl hover:scale-110 transition delay-200 duration-200 ease-in-out"
                onClick={() => {}}
              >
                <img
                  src={poke.img}
